...
#' @param clr color of graph default "blue"
...
```{r}
# play with it! examples of informal sensitivity analysis
solarpv(area = 0.5, 
        eff = 0.8, 
        PR = 0.75, 
        solar = sierraczosolar, 
...
The R 'purrr' package is good for looping, apply a family of function. 